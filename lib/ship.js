(function () {
		...
		Ship.prototype.power = function(impulse){
		  this.vel[0] += impulse * Math.cos(this.dir)/2;
		  this.vel[1] += impulse * Math.sin(this.dir)/2;
		...
		Ship.prototype.fireBullet = function(){
			...
			var velX =  (magnitude)* Math.cos(direction);
			var velY =  (magnitude) * Math.sin(direction);
